...
class deletenode2 {
    ...
    * linked list */
    void deleteNode(int key)
    {
        ...
        while (temp != null && temp.data != key) {      //if temp is null and data of temo is not equal to key
            prev = temp;                                //previous will be equal to temp
            temp = temp.next;                           //value of temp will be same of temp.next
        }
